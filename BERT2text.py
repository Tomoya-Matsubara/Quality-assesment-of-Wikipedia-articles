...
BERT_LIMIT = 512
BERT_FIRST = 300
BERT_LAST = BERT_LIMIT - BERT_FIRST
...
def BERT(file_name):
  ...
  if len(indexed_tokens) > BERT_LIMIT :
    indexed_tokens = indexed_tokens[:BERT_FIRST] + indexed_tokens[-BERT_LAST:]
    segments_ids = segments_ids[:BERT_FIRST] + segments_ids[-BERT_LAST:]
